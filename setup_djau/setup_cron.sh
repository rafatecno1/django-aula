...
echo "----------------------------------------"
echo -e "1. ${C_EXITO}Un cop finalitzada la càrrega inicial de dades i configurat els usuaris.${RESET}"
echo -e "2. Edita el fitxer ${C_EXITO}'$FULL_PATH/aula/settings_local.py'${RESET}"
echo "3. Canvia la línia:"
echo -e "   ${C_ERROR}DEBUG = True${RESET}"
echo "   A:"
echo -e "   ${C_EXITO}DEBUG = False${RESET}"
echo -e "4. ${C_EXITO}Reinicia el servidor Apache (sudo systemctl restart apache2) o, per a més seguretat, tot el servidor.${RESET}"
echo -e "\n"
echo -e "${C_TITULO}====================================================================================================${RESET}"
echo -e "\n"
